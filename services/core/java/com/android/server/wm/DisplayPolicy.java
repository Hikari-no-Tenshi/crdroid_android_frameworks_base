...
import static android.view.WindowManager.LayoutParams.TYPE_SYSTEM_FINGERPRINT_DIM;
...
public class DisplayPolicy {
    ...
    public void beginLayoutLw(DisplayFrames displayFrames, int uiMode) {
        ...
        boolean updateSysUiVisibility = layoutNavigationBar(displayFrames, uiMode, navVisible & fodHidden,
            ...
            if (layoutInScreen && layoutInsetDecor) {
                ...
                if (type == TYPE_STATUS_BAR_PANEL || type == TYPE_STATUS_BAR_SUB_PANEL) {
                    ...
                    if (DEBUG_LAYOUT) Slog.v(TAG, "Laying out navigation bar window: " + pf);
                        ...
                        || type == TYPE_SYSTEM_FINGERPRINT || type == TYPE_SYSTEM_FINGERPRINT_DIM
                        || type == TYPE_SYSTEM_FINGERPRINT_HIGH_LIGHT) && ((fl & FLAG_FULLSCREEN) != 0)) {
